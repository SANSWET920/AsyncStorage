...
<TouchableOpacity style={styles.avatarPlaceholder}  onPress={this.handlePickAvatar}>
      ...
      <AlertPro
          ...
          title="1. Please do fill all the details given above (Username,Email,Password,Profile Pic also)"
          message="2. Every time you update your profile, use change different email"
          textCancel="Cancel"
          textConfirm="OK"
          customStyles={{
            mask: {
